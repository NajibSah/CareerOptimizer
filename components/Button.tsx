...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'outline' | 'canva';
  isLoading?: boolean;
}
...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-indigo-600 dark:bg-indigo-500 text-white hover:bg-indigo-700 dark:hover:bg-indigo-600 shadow-md hover:shadow-indigo-500/30",
    ...
    canva: "bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:shadow-xl hover:scale-[1.02] shadow-lg uppercase tracking-wider text-sm"
  };
